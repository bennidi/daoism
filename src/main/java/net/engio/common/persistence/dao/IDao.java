...
import net.engio.common.persistence.dao.query.Query.TypedQuery;
 ...
 * {@link net.engio.common.persistence.Entity} such that the same dao instance can be shared among multiple instances of {@link IRepository}.
 * 
...
public interface IDao {
	 ...
	 * 
	 * @param <D>
	 *            any subtype of {@link net.engio.common.persistence.Entity} welcome
	 * @param domainClass
	 ...
	 * 
	 * @param <D> Any subtype of {@link net.engio.common.persistence.Entity} welcome
	...
	/**
	 * Find domain objects using a {@link net.engio.common.persistence.dao.query.ISelect} (polymorphic)
	 * 
	 * @param <D> Any subtype of {@link net.engio.common.persistence.Entity} welcome
	 * @param domainClass The upper bound of the class hierarchy that will be considered in the query
	...
	/**
	 * The method is used to persist an instance of {@link net.engio.common.persistence.Entity} to the underlying storage
	 * 
	 * @param <D> Any subtype of {@link net.engio.common.persistence.Entity} welcome
	...
	/**
	 * The method is used to persist a list of instances of {@link net.engio.common.persistence.Entity}. It applies the semantics
