 ...
 * {@link net.engio.common.persistence.Entity}. {@link This} interface offers exactly the same functionality as the {@link IDao}, meaning that the corresponding
 * methods share the same semantics
 * 
 * @author Benjamin Diedrichsen
 * 
 * @param <KEY>
 *            The type of primary key used for the {@link net.engio.common.persistence.Entity}
 * @param <E>
