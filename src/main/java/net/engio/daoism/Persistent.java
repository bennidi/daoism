 ...
 * For type-safety there also exists a typed interface {@link ITypedDao} which uses generics to offer the same methods as {@link net.engio.daoism.dao.IPersistenceProvider}
