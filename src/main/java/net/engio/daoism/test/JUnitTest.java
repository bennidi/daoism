...
import net.engio.daoism.test.tasks.IDataInitializationTask;
import net.engio.daoism.test.tasks.RequiredDataInitialization;
import net.engio.daoism.utils.ReflectionUtils;
